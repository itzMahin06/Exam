import { getFirebase, doc, getDoc, collection, addDoc, serverTimestamp } from "./firebase-init.js";
...
function backToCourses(msg, extraLinkHtml = "") {
  examBody.innerHTML = `<div class="empty-state"><div class="ico">🔒</div><p>${msg}</p>
